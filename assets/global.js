...
class MenuDrawer extends HTMLElement {
  ...
  onSummaryClick(event) {
    ...
    if (event.currentTarget.parentNode.closest('menu-drawer')) {
    ...
    if (detailsElement === this.mainDetailsToggle) {
      ...
      setTimeout(() => {
        ...
        detailsElement.hasAttribute('open') && summaryElement.setAttribute('aria-expanded', 'true');
...
class Drawer extends HTMLElement {
  constructor() {
    ...
    document.getElementById('rebuy-cart-close')?.addEventListener(
      "click",
      (e) => {
        e.preventDefault();
        this.closeDrawer();
