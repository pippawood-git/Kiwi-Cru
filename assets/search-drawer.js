class SearchDrawerToggle extends HTMLElement {
  constructor() {
    super();
    this.searchInputWrapper = document.querySelector('.f-search-drawer__field');
    this.searchInput = this.searchInputWrapper.querySelector('input');

    this.setupEventListeners();

    if (document.querySelector('.f-template-search--empty') !== null) {
      this.searchInputWrapper.classList.remove('active')
    }
  }

  setupEventListeners() {
    this.addEventListener('click', this.toggleSearchInput.bind(this));
  }

  toggleSearchInput() {
    this.searchInputWrapper.classList.toggle('active');
...
class PredictiveSearch extends HTMLElement {
  constructor() {
    ...
    this.selectors = {
      ...
      searchDropdown: '.header-search-form__dropdown',
      searchInputIcon: '.f-search-drawer__field-icon .f-icon-close',
    };
    ...
    this.searchDropdown = this.domNodes.searchDropdown;
    this.searchInputIcon = this.domNodes.searchInputIcon;
  ...
  setupEventListeners() {
    ...
    this.searchInputIcon?.addEventListener('click', () => {
      this.close();
    });
  }
  ...
  open() {
    ...
    this.isOpen = true;
    this.searchDropdown.dataset.open = 'true';
  }
  ...
  close(clearSearchTerm = false) {
    ...
    this.searchDropdown.dataset.open = 'false';
...
customElements.define('search-drawer-toggle', SearchDrawerToggle);
